...
1. **Vertical Scaling** - Optimise processes and increase throughput using **same machine** Increase more power in single machine, expect more output from it. But it has its limit such as hardware limitation or excessive cost.
